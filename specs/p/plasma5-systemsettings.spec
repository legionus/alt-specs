...
Provides: kf5-systemsettings-common = %EVR
Obsoletes: kf5-systemsettings-common < %EVR
%description common
%name common package
...
Provides: kf5-systemsettings-devel = %EVR
Obsoletes: kf5-systemsettings-devel < %EVR
%description devel
...
%install
%K5install
%K5install_move data systemsettings kpackage
...
- renamed kf5-systemsettings -> plasma5-systemsettings
