...
Provides: kf5-khotkeys = %EVR
Obsoletes: kf5-khotkeys < %EVR
...
Provides: kf5-khotkeys-common = %EVR
Obsoletes: kf5-khotkeys-common < %EVR
%description common
%name common package
...
Provides: kf5-khotkeys-devel = %EVR
Obsoletes: kf5-khotkeys-devel < %EVR
%description devel
...
- renamed kf5-khotkeys -> plasma5-khotkeys
