...
Provides: kf5-ksshaskpass = %EVR
Obsoletes: kf5-ksshaskpass < %EVR
...
Provides: kf5-ksshaskpass-common = %EVR
Obsoletes: kf5-ksshaskpass-common < %EVR
%description common
%name common package
...
Provides: kf5-ksshaskpass-devel = %EVR
Obsoletes: kf5-ksshaskpass-devel < %EVR
%description devel
...
- renamed kf5-ksshaskpass -> plasma5-ksshaskpass
