...
%global repo            cockroach-go
# https://github.com/cockroachdb/cockroach-go
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          c806b484b8611fc587b6abc07f8bb0f7824a78d6
%global commitdate      20170809
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        alt1_0.2.%{commitdate}git%{shortcommit}
Summary:        CockroachDB helpers for Go (Golang)
License:        Apache-2.0
...
Provides:      golang(%{import_path}/crdb) = %{version}-%{release}
...
%gotest %{import_path}/crdb
%gotest %{import_path}/testserver
%endif
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.2.20170809gitc806b48
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.1.20170809gitc806b48
- new version
