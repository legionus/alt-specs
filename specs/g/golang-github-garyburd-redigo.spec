...
%global with_debug 0
# error connection to database, dial tcp :6379
%global with_check 0
...
%gotest %{import_path}/redis
%gotest %{import_path}/redisx
%endif
...
%changelog
* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.10.git3e4727f
- new version
