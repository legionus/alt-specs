...
cp -pav test.htdigest %{buildroot}/%{go_path}/src/%{import_path}/
echo "%%{go_path}/src/%%{import_path}/test.htdigest" >> unit-test.file-list
cp -pav test.htpasswd %{buildroot}/%{go_path}/src/%{import_path}/
echo "%%{go_path}/src/%%{import_path}/test.htpasswd" >> unit-test.file-list
%endif
...
%changelog
* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.11.gitc0ef453
- new version
