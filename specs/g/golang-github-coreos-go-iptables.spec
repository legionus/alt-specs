...
# it needs iptables with --wait option and run as the root
%global with_check 0
...
%global repo            go-iptables
# https://github.com/coreos/go-iptables
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          259c8e6a4275d497442c721fa52204d7a58bde8b
...
Provides:      golang(%{import_path}/iptables) = %{version}-%{release}
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.11.git259c8e6
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.10.git259c8e6
- new version
