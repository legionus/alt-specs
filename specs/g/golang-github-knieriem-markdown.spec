...
%global project         knieriem
%global repo            markdown
...
%description
This is an implementation of John Gruber's markdown in Go.
...
#BuildRequires: golang(rand)
#%endif

#Requires:      golang(rand)
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_5.git325ec6c
- fc update

* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_4.git325ec6c
- new version
