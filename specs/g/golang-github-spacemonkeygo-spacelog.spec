...
Requires:      golang(github.com/spacemonkeygo/flagfile/utils)

Provides:      golang(%{import_path}) = %{version}-%{release}
Provides:      golang(%{import_path}/setup) = %{version}-%{release}
...
%changelog
* Wed Dec 13 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.8.gitae95ccc
- new version
