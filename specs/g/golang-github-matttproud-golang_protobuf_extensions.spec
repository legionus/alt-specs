...
Requires:        golang(github.com/golang/protobuf/proto/testdata)
...
%gotest %{import_path}/pbtest
#%gotest %{import_path}/pbutil
%endif
...
%changelog
* Fri Mar 16 2018 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.16.gitc12348c
- fc update

* Sat Dec 09 2017 Igor Vlasenko <viy@altlinux.ru> 0-alt1_0.15.gitc12348c
- new version
