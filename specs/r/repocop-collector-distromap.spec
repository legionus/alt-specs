%define collectorname distromap
...
Summary: %collectorname (DistroMap DB) collector for repocop test platform
...
install -m 644 %collectorname.options $RPM_BUILD_ROOT%_datadir/repocop/pkgcollectors/%collectorname/options
...
%changelog
* Mon Aug 22 2011 Igor Vlasenko <viy@altlinux.ru> 0.01-alt1
