...
Summary: KDE Frameworks 5 Access to the windowing system
...
# optimized out: cmake cmake-modules elfutils libEGL-devel libGL-devel libICE-devel libSM-devel libX11-devel libXau-devel libXext-devel libXfixes-devel libXi-devel libXrender-devel libXt-devel libcloog-isl4 libqt5-core libqt5-gui libqt5-test libqt5-widgets libqt5-x11extras libqt5-xml libstdc++-devel libxcb-devel libxcbutil-keysyms pkg-config python-base qt5-base-devel qt5-tools ruby ruby-stdlibs xorg-fixesproto-devel xorg-kbproto-devel xorg-xf86miscproto-devel xorg-xproto-devel
...
BuildRequires: libXv-devel libXxf86misc-devel libXxf86vm-devel libxcbutil-keysyms-devel libxkbfile-devel
BuildRequires: gcc-c++ extra-cmake-modules qt5-base-devel qt5-tools-devel qt5-x11extras-devel
...
%files devel
%_K5inc/kwindowsystem_version.h
%_K5inc/KWindowSystem/
%_K5link/lib*.so
%_K5lib/cmake/KF5WindowSystem
%_K5archdata/mkspecs/modules/qt_KWindowSystem.pri
