...
%package -n libkf5alarmcalendar
Group: System/Libraries
Summary: KF5 library
Requires: %name-common = %version-%release
%description -n libkf5alarmcalendar
KF5 library
...
%_K5inc/KAlarmCal/
%_K5link/lib*.so
%_K5lib/cmake/KF5AlarmCalendar
%_K5archdata/mkspecs/modules/qt_KAlarmCal.pri
