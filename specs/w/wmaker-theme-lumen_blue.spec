...
Provides: lumen_blue-theme = %version-%release
Obsoletes: lumen_blue-theme
...
%install
mkdir -p %buildroot%_datadir/WindowMaker/Themes/Lumen_Blue.themed/
install -m644 * %buildroot%_datadir/WindowMaker/Themes/Lumen_Blue.themed/

%files
%_datadir/WindowMaker/Themes/Lumen_Blue.themed/
