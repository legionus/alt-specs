...
Requires: R-%oname = %version-%release
...
%files -n R-%oname -f INSTALL_R

%changelog
* Tue May 27 2014 Eugeny A. Rostovtsev (REAL) <real at altlinux.org> 2.4.0-alt2
